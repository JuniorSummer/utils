...
if __name__ == '__main__':
    ...
    print(f"prompt eval duration: {stats['first_token_time']:.3f}s") # 模型生成第一个回复token的时间
    print(f"prompt eval rate:     {stats['prompt_tokens']/stats['first_token_time']:.3f} tokens/s") # 模型思考速度
    print(f"eval count:           {stats['output_tokens']} token(s)") # 输出内容总token数
